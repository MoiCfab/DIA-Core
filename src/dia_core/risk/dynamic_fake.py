...
from dia_core.market_state.fake import current_exposure_pct as _expo, orders_last_min as _olm
...
def build_risk_context(
    *, equity: float, open_notional: float | None = None, fallback_orders_last_min: int | None = None
) -> RiskContext:
